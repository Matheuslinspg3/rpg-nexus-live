...
function DiscordCampaignSettings({ campaignCode }: { campaignCode: string }) {
  const [form, setForm] = useState({ enabled: false, guildId: "", audiovisualChannelId: "", diceChannelId: "", musicChannelId: "" });
